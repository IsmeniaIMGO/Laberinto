package Laberinto.test;
//Nota: este trabajo se pudo realizar con la guia del profesor y la ayuda de un compañero de clase
...
public class LaberintoPrueba {
	...
	public static void main(String[] args) {
		// construimos un objeto de la clase Laberinto por defecto
		LaberintoPrueba m = new LaberintoPrueba(); 	
		
		// introducimos en este caso, la salida (X) en las coordenadas
		m.laberinto[1][1] = 'X'; 
		m.laberinto[1][8] = 'X';
		m.laberinto[7][3] = 'X';
		m.laberinto[1][7] = 'X';
		...
		m.resuelve(8, 1); 		
		// imprimimos el laberinto ya resuelto (si tiene soluci�n)
    ...
    private boolean paso(int x, int y){
    	 ...
    	 laberinto[x][y]='f'; // en el caso de no ser el resultado, se marca con f. Ya fue pisado
